...
public class PlayGame {
    ...
    public static void main(String[] args) {
        System.out.println("welCoMe tO tHe gAme\nYou wake up with your head pounding, and blood stinging your eyes."
        		+ " As you crawl out of your ship, you remember the collision you had with an asteriod when making "
        ...
        while (! game.isOver()) 
            parser.executeTurn();
        	if (game.getInventory().allItemsAcquired() && game.getCurrentRoom().getDescription() == 
        			"You find yourself in a small room with scattered tools and parts. Something is sparking.") {
        		game.finishGame();
        	}
